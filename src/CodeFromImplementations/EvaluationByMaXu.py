...
class Evaluation(object):
    ...
    def _f1_measure(self) -> float:
        ...
        """
        assert len(self.predict) == len(self.label)
        return f1_score(self.label, self.predict, average='micro', zero_division=0) #THIS LINE HAS BEEN MODIFIED TO REMOVE THE ZERO DIV WARNING
    ...
    def _f1_macro(self) -> float:
        ...
        """
        assert len(self.predict) == len(self.label)
        return f1_score(self.label, self.predict, average='macro', zero_division=0)#THIS LINE HAS BEEN MODIFIED TO REMOVE THE ZERO DIV WARNING
    ...
    def _f1_macro_weighted(self) -> float:
        ...
        """
        assert len(self.predict) == len(self.label)
        return f1_score(self.label, self.predict, average='weighted', zero_division=0)#THIS LINE HAS BEEN MODIFIED TO REMOVE THE ZERO DIV WARNING
