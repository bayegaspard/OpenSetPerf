...
opt_func = {"Adam":torch.optim.Adam,"SGD":torch.optim.SGDSSS}
helper_variables = {
    "phase" : -1,
    "startphase" : 0,
    "e": 0
...
parameters = {
    ...
    "num_workers":[6, "Number of threads working on building batches"],
    ...
    "optimizer":opt_func["Adam"], "Unknowns":"refer to unknowns.CSV",
